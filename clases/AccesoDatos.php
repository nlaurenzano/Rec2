...
class AccesoDatos
{
    ...
    private function __construct()
    {
        try {
            ...
            $this->objetoPDO = new PDO('mysql:host=localhost;dbname=listados;charset=utf8', 'root', '', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
